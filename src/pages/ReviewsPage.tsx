...
import { Star, StarHalf, Quote, ArrowRight, ShieldCheck, Award, HeartHandshake } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-darker text-white selection:bg-white selection:text-black">
      ...
      <main className="pt-32 md:pt-40 pb-24">
        {/* Page Header */}
        <section className="container mx-auto px-6 md:px-12 mb-20 md:mb-24">
          <motion.div
          ...
          >
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-display font-bold uppercase tracking-tight mb-6">
              Client <br />Reviews & Trust
            </h1>
            <p className="text-white/70 font-light text-base sm:text-lg max-w-2xl leading-relaxed">
              Stories and feedback from corporate leadership, event directors, luxury brands, and creative partners who trusted Aman Visual for their flagship productions.
            </p>
          </motion.div>

          {/* Aggregate Rating Banner */}
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 p-6 sm:p-8 bg-charcoal border border-white/10 max-w-4xl">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-amber-400/10 flex items-center justify-center text-amber-400 shrink-0">
                <Award className="w-6 h-6" />
              </div>
              <div>
                <div className="text-2xl font-bold font-display">4.9 / 5.0</div>
                <div className="text-xs text-white/50 uppercase tracking-wider">Overall Client Rating</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 sm:border-l sm:border-white/10 sm:pl-6">
              ...
              <div>
                ...
                <div className="text-xs text-white/50 uppercase tracking-wider">On-Time Delivery</div>
              </div>
            </div>

            <div className="flex items-center gap-4 sm:border-l sm:border-white/10 sm:pl-6">
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white/80 shrink-0">
                <HeartHandshake className="w-6 h-6" />
              </div>
              <div>
                <div className="text-2xl font-bold font-display">120+</div>
                <div className="text-xs text-white/50 uppercase tracking-wider">Completed Shoots</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 md:px-12 mb-28">
          <div className="pt-16 border-t border-white/10">
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-display font-bold uppercase tracking-tight mb-4">
                Trusted by Industry Giants & Leading Brands
              </h2>
              <p className="text-xs font-mono uppercase tracking-[0.25em] text-white/40">
                Collaborative Media & Cinematography Partnerships
              </p>
        ...
        <section className="container mx-auto px-6 md:px-12">
          <div className="bg-charcoal border border-white/10 p-10 md:p-16 text-center max-w-4xl mx-auto flex flex-col items-center">
            <h3 className="text-3xl md:text-4xl font-display font-bold uppercase mb-4">
              Ready to create something iconic?
            </h3>
            <p className="text-white/60 text-sm md:text-base max-w-xl mb-8">
              Whether you need live shoot cinematography, brand campaigns, corporate documentary, or aerial coverage, let's bring your vision to life.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                to="/#contact"
                className="px-8 py-3 bg-white text-black font-mono uppercase text-xs tracking-widest hover:bg-white/90 transition-colors inline-flex items-center gap-2"
              >
              ...
              <Link
                to="/client-galleries"
                className="px-8 py-3 border border-white/20 text-white font-mono uppercase text-xs tracking-widest hover:border-white transition-colors"
              >
                <span>View Deliverables Portal</span>
              </Link>
            </div>
          </div>
        </section>
